...
from testing import string_test,label_string_test
...
df = pandas.read_csv('C:\Users\user\Google Drive\Skripsi\coba.csv', 
                     names=["Content", "Label"])
...
spam_detector = LinearSVC().fit(X_train_tf, Label)
...
prediksi_semua = spam_detector.predict(X_train_tf)
